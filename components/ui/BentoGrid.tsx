...
// Use dynamic import for Lottie to avoid document not defined errors
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    if (typeof window !== 'undefined' && navigator.clipboard) {
      const text = "daksh.h.prajapati12@gmail.com";
            ...
            <div className="mt-5 relative">
              {copied && (
                <div className="absolute -bottom-5 right-0">
                  {/* Use DynamicLottie instead of direct Lottie import */}
                  <DynamicLottie animationData={animationData} height={200} width={400} />
                </div>
              )}
